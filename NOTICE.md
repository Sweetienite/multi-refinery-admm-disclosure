...
The original benchmark is licensed under CC BY-NC-SA 4.0.

This repository **does not redistribute** the original benchmark files. Users must
obtain them from the upstream repository and comply with the upstream license terms.
