...
本同步版以论文当前权威数值替换了旧发布材料，统一五分量评分、中心化协同增量分母和欧氏投影口径，并加入 8 张 600 dpi 分图及相对路径出图/验证入口。该“8 张”范围在 2026-08-07 已被最终 Word 稿的 6 个正文图面板取代；两张删除面板转为补充/历史材料，详见 `MANUSCRIPT_ASSET_CONTRACT_20260807.md`。
