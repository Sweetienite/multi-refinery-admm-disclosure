...
| H4D1R counts | The current row-level audit is `60/26/16`. The manuscript/H5 `60/24/15` appears only in historical documentation/constants; the row-level source corresponding to that old count is not present in either repository. |
